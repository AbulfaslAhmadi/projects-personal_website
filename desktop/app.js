document.addEventListener("scroll", () => {
    ...
    if(commentsScroll > -300 && commentsScroll < 1200) {
        commentOne.style.transform = `translate(${commentsScroll}px) rotate(${-180 + (commentsScroll / 4)}deg)`;
        commentTwo.style.transform = `translate(${-commentsScroll}px) rotate(${135 + (commentsScroll / 4)}deg)`;
    }
})
